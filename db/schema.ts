// Single source of truth for the schema DDL, importable by the migration runner
// and the /api/admin/setup route (serverless functions can't reliably fs-read the
// .sql file from the bundle). Keep db/schema.sql in sync for human reference.
